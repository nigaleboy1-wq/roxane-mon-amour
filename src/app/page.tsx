...
// ─── Animated Line ───
function PoemLine({ children, delay = 0, className = '' }: { children: string; delay?: number; className?: string }) {
  ...
  return (
    <section id="poeme" className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20">
      ...
      <div className="max-w-xl space-y-5 relative z-10">
        <PoemLine delay={0.2}>Dans le silence de la nuit,</PoemLine>
        ...
        <PoemLine delay={2.8}>Chaque seconde loin de toi</PoemLine>
        ...
        <PoemLine delay={4.1} className="text-lg md:text-xl" style={{ color: 'rgba(255,160,170,1)' }}>
          Tu es la plus belle histoire
        </PoemLine>
        <PoemLine delay={4.4} className="text-lg md:text-xl" style={{ color: 'rgba(255,160,170,1)' }}>
          que la vie m&apos;ait jamais offerte.
        </PoemLine>
      </div>
    </section>
  )
...
function ReasonsSection() {
  const reasons = [
    { emoji: '✨', text: 'Ton rire qui illumine ma journée entière' },
    ...
    { emoji: '🌹', text: 'Ton regard qui me fait fondre' },
    { emoji: '💫', text: 'Chaque moment passé ensemble est un trésor' },
...
function TimelineSection() {
  const moments = [
    { title: 'Notre rencontre', text: 'Le jour où tout a commencé, où le monde a changé de couleur grâce à toi.', icon: '💫' },
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center px-6 py-24 overflow-hidden">
      ...
      >
        ...
        <motion.h2
          className="text-3xl md:text-4xl lg:text-5xl font-light tracking-wide mb-8"
          style={{
            fontFamily: "'Georgia', 'Times New Roman', serif",
        ...
        >
          de tout ce que mon cœur ressent pour toi.
        </motion.p>
        <motion.p
    ...
    <div className="relative" style={{ background: 'linear-gradient(180deg, #0d0508 0%, #1a0a0e 15%, #150812 40%, #0d0a1a 70%, #0d0508 100%)' }}>
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(ellipse at center, transparent 40%, rgba(10, 5, 8, 0.7) 100%)',
          }}
        />
      </motion.section>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(to bottom, transparent, #0d0508)',
        }}
      />
    </div>
  )
